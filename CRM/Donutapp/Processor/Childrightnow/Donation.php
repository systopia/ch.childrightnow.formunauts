...
class CRM_Donutapp_Processor_Childrightnow_Donation extends CRM_Donutapp_Processor_Childrightnow_Base {
  ...
  protected function createRecruitmentActivity($donation, $contact_id, $mandate)
  {
    ...
    $activity_data['details'] = $smarty->fetch(E::path('resources/Childrightnow/RecruitmentActivity.tpl'));
